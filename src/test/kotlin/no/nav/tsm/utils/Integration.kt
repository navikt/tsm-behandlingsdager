...
abstract class WithKafka {
    companion object {
        val kafka: ConfluentKafkaContainer = ConfluentKafkaContainer("confluentinc/cp-kafka:8.1.0").apply { start() }
        ...
        fun integrationEnvironment(): Environment {
            val config =
                Properties().apply {
                    ...
                    this[ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG] = ByteArrayDeserializer::class.java.name
